...
export const baseTasks: Task[] = [
	...
	{ from: 14, to: 17, text: 'Reset triangle vision, sentry chokes', image: './ward position.jpg' },
	{ from: 17, to: 20, text: '📣 Smoke Gank #4: Prepare for Roshan', image: './smoke.jpeg' },
	{
		from: 20,
		to: 25,
		text: 'Deep vision, control triangle, secure jungle',
		image: './ward position.jpg'
	},
	{ from: 25, to: 30, text: '📣 Smoke Gank #5: Catch enemy split-pushing', image: './smoke.jpeg' },
	{ from: 30, to: 35, text: 'Re-establish wards, play safe vision', image: './ward position.jpg' },
	{ from: 35, to: 40, text: '📣 Smoke Gank #6: Set up high-ground siege', image: './smoke.jpeg' },
	{ from: 40, to: 45, text: 'Check Roshan, defend triangle', image: './ward position.jpg' },
	{ from: 45, to: 50, text: '📣 Smoke Gank #7: Break stalemate or flank', image: './smoke.jpeg' },
	{
		from: 50,
		to: 60,
		text: 'Secure vision, late-game smokes, reset vision',
		image: './ward position.jpg'
	}
];
